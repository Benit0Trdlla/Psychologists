export default function PsychologistsSearch() {
    return (
        <>
            <div className="container border border-success rounded-3">
                <h1 className="text-center p-3 mb-0"> Buscar un psicólogo y psicoterapeuta en línea / en persona
                </h1>
