...
import 'swiper/css/pagination';   // ← esto es clave
    ...
    <>
      ...
      <section className="container px-0 text-center py-5">
        ...
        <div className="row gap-3 mx-auto">
          <div className="col-12 col-md-6 col-lg-4 border border-success rounded-4" style={{ height: "454.58px", width: "360px", padding: "20px" }}>
            <div className="bg-success h-100 position-relative">
