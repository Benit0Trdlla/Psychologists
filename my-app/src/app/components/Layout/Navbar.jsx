...
export default function Navbar({img, flag}) {
    const arr_flags = [
        { name: 'es', flag: 'https://flagcdn.com/es.svg' },
        { name: 'gb', flag: 'https://flagcdn.com/gb.svg' },
                            ...
                            <ul className="navbar-nav ms-auto gap-md-1 align-items-center">
                                ...
                                <li className="nav-item dropdown">
                                    <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <img src={flag ? `https://flagcdn.com/${flag}.svg` : arr_flags[3].flag} alt={`Bandera de ${flag ? flag : arr_flags[3].name}`} className="ms-1" width="28" height="20" />
                                    </a>
                                    <ul className="dropdown-menu">
                                        {arr_flags.map((flag, index) => (
                                            <li key={index}><Link className="dropdown-item" href={`/${flag.name}/Psychologists/Search`}><img src={flag.flag} alt="flag" className="me-2" width="28" height="20" /></Link></li>
                                        ))}
                                    </ul>
                                </li>
                            </ul>
